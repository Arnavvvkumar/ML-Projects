...
# === Configuration ===
RETRAIN = True  # Set to True if you want to retrain the model
...
def generate_quote_with_suggestions(theme, starting_text, num_words, top_k):
    # Build the seed: theme token + optional user-provided starting_text
    ...
    # Return the generated quote and first-step suggestions
